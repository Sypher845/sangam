...
android {
    ...
    // ndkVersion = flutter.ndkVersion // Commented out to let Gradle auto-download compatible NDK
    ...
    defaultConfig {
        ...
        // Securely pass API key from local.properties to AndroidManifest.xml
